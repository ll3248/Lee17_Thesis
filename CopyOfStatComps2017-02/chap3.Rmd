...
```{r erdosrenyisim, eval = FALSE, echo = TRUE}
set.seed(499)
...
```{r wattsstrogatzsim, eval = FALSE, echo = TRUE}
set.seed(499)
...
```{r ergmmods, eval = FALSE, echo = TRUE}
