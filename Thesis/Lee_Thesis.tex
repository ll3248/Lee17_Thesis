...
their unique properties? To answer this question, we begin with an
overview of networks, including network statistics, and graph models. We
decide to look at Erdős-Rényi and Watts-Strogatz models as well as
exponential random graph models (ERGMs). We conduct a simulation study
where we apply various graph models to an observed network. Here, we
choose to analyze a component of the Facebook network. We compare the
...
Watts-Strogatz models do not seem to accurately fit the Facebook network
for these network statistics. ERGMs that use only combinations of edge,
triangle, and k-star parameters also do not accurately model this
Facebook network. However, the results suggest that adding other
...
\begin{document}
  ...
  \KeywordTok{plot}\NormalTok{(g2.ws, }\DataTypeTok{vertex.size =} \DecValTok{20}\NormalTok{, }\DataTypeTok{vertex.label.cex =} \FloatTok{0.75}\NormalTok{, }\DataTypeTok{layout=}\NormalTok{layout_in_circle)}
  \end{Highlighting}
  \end{Shaded}
  ...
  (edged, triangles, and k-stars of sie \(3\)).
  ...
  \NormalTok{for (i in }\DecValTok{1}\NormalTok{:numsim) \{}
    ...
    \NormalTok{g.ergm1a.fbg.sim.coef[i] <-}\StringTok{ }\KeywordTok{transitivity}\NormalTok{(g.ergm.fbg.sim.convert, }\DataTypeTok{type=}\StringTok{"localaverage"}\NormalTok{)}
    \NormalTok{g.ergm1a.fbg.sim.apl[i] <-}\StringTok{ }\KeywordTok{average.path.length}\NormalTok{(g.ergm.fbg.sim.convert)}
    \NormalTok{g.ergm1a.fbg.sim.dia[i] <-}\StringTok{ }\KeywordTok{diameter}\NormalTok{(g.ergm.fbg.sim.convert)}
    \NormalTok{g.ergm1a.fbg.sim.avgdeg[i] <-}\StringTok{ }\KeywordTok{mean}\NormalTok{(igraph::}\KeywordTok{degree}\NormalTok{(g.ergm.fbg.sim.convert))}
    \NormalTok{g.ergm1a.fbg.sim.avgbtwcen[i] <-}\StringTok{ }\KeywordTok{mean}\NormalTok{(igraph::}\KeywordTok{betweenness}\NormalTok{(g.ergm.fbg.sim.convert))}
    \NormalTok{g.ergm1a.fbg.sim.avgclocen[i] <-}\StringTok{ }\KeywordTok{mean}\NormalTok{(igraph::}\KeywordTok{closeness}\NormalTok{(g.ergm.fbg.sim.convert))}
    \NormalTok{g.ergm1a.fbg.sim.avgeigveccen[i] <-}\StringTok{ }\KeywordTok{mean}\NormalTok{(igraph::}\KeywordTok{eigen_centrality}\NormalTok{(g.ergm.fbg.sim.convert)$vector)}
  \NormalTok{\}}
  
  \NormalTok{g.ergm1a.fbg.sim.df <-}\StringTok{ }\KeywordTok{as.data.frame}\NormalTok{(}\KeywordTok{cbind}\NormalTok{(g.ergm1a.fbg.sim.ecount, g.ergm1a.fbg.sim.coef, }
                                             \NormalTok{g.ergm1a.fbg.sim.apl, g.ergm1a.fbg.sim.dia, }
                                             \NormalTok{g.ergm1a.fbg.sim.avgdeg, g.ergm1a.fbg.sim.avgbtwcen, }
                                             \NormalTok{g.ergm1a.fbg.sim.avgclocen, g.ergm1a.fbg.sim.avgeigveccen))}
  ...
  \NormalTok{for (i in }\DecValTok{1}\NormalTok{:numsim) \{}
    ...
    \CommentTok{#observe the network statistics for this simulated graph}
    \NormalTok{g.ergm2a.fbg.sim.ecount[i] <-}\StringTok{ }\KeywordTok{ecount}\NormalTok{(g.ergm.fbg.sim.convert)}
    \NormalTok{g.ergm2a.fbg.sim.coef[i] <-}\StringTok{ }\KeywordTok{transitivity}\NormalTok{(g.ergm.fbg.sim.convert, }\DataTypeTok{type=}\StringTok{"localaverage"}\NormalTok{)}
    \NormalTok{g.ergm2a.fbg.sim.apl[i] <-}\StringTok{ }\KeywordTok{average.path.length}\NormalTok{(g.ergm.fbg.sim.convert)}
    \NormalTok{g.ergm2a.fbg.sim.dia[i] <-}\StringTok{ }\KeywordTok{diameter}\NormalTok{(g.ergm.fbg.sim.convert)}
    \NormalTok{g.ergm2a.fbg.sim.avgdeg[i] <-}\StringTok{ }\KeywordTok{mean}\NormalTok{(igraph::}\KeywordTok{degree}\NormalTok{(g.ergm.fbg.sim.convert))}
    \NormalTok{g.ergm2a.fbg.sim.avgbtwcen[i] <-}\StringTok{ }\KeywordTok{mean}\NormalTok{(igraph::}\KeywordTok{betweenness}\NormalTok{(g.ergm.fbg.sim.convert))}
    \NormalTok{g.ergm2a.fbg.sim.avgclocen[i] <-}\StringTok{ }\KeywordTok{mean}\NormalTok{(igraph::}\KeywordTok{closeness}\NormalTok{(g.ergm.fbg.sim.convert))}
    \NormalTok{g.ergm2a.fbg.sim.avgeigveccen[i] <-}\StringTok{ }\KeywordTok{mean}\NormalTok{(igraph::}\KeywordTok{eigen_centrality}\NormalTok{(g.ergm.fbg.sim.convert)$vector)}
  \NormalTok{\}}
  
  \NormalTok{g.ergm2a.fbg.sim.df <-}\StringTok{ }\KeywordTok{as.data.frame}\NormalTok{(}\KeywordTok{cbind}\NormalTok{(g.ergm2a.fbg.sim.ecount, g.ergm2a.fbg.sim.coef, }
                                             \NormalTok{g.ergm2a.fbg.sim.apl, g.ergm2a.fbg.sim.dia, }
                                             \NormalTok{g.ergm2a.fbg.sim.avgdeg, g.ergm2a.fbg.sim.avgbtwcen, }
                                             \NormalTok{g.ergm2a.fbg.sim.avgclocen, g.ergm2a.fbg.sim.avgeigveccen))}
  ...
  \NormalTok{for (i in }\DecValTok{1}\NormalTok{:numsim) \{}
    ...
    \CommentTok{#observe the network statistics for this simulated graph}
    \NormalTok{g.ergm2b.fbg.sim.ecount[i] <-}\StringTok{ }\KeywordTok{ecount}\NormalTok{(g.ergm.fbg.sim.convert)}
    \NormalTok{g.ergm2b.fbg.sim.coef[i] <-}\StringTok{ }\KeywordTok{transitivity}\NormalTok{(g.ergm.fbg.sim.convert, }\DataTypeTok{type=}\StringTok{"localaverage"}\NormalTok{)}
    \NormalTok{g.ergm2b.fbg.sim.apl[i] <-}\StringTok{ }\KeywordTok{average.path.length}\NormalTok{(g.ergm.fbg.sim.convert)}
    \NormalTok{g.ergm2b.fbg.sim.dia[i] <-}\StringTok{ }\KeywordTok{diameter}\NormalTok{(g.ergm.fbg.sim.convert)}
    \NormalTok{g.ergm2b.fbg.sim.avgdeg[i] <-}\StringTok{ }\KeywordTok{mean}\NormalTok{(igraph::}\KeywordTok{degree}\NormalTok{(g.ergm.fbg.sim.convert))}
    \NormalTok{g.ergm2b.fbg.sim.avgbtwcen[i] <-}\StringTok{ }\KeywordTok{mean}\NormalTok{(igraph::}\KeywordTok{betweenness}\NormalTok{(g.ergm.fbg.sim.convert))}
    \NormalTok{g.ergm2b.fbg.sim.avgclocen[i] <-}\StringTok{ }\KeywordTok{mean}\NormalTok{(igraph::}\KeywordTok{closeness}\NormalTok{(g.ergm.fbg.sim.convert))}
    \NormalTok{g.ergm2b.fbg.sim.avgeigveccen[i] <-}\StringTok{ }\KeywordTok{mean}\NormalTok{(igraph::}\KeywordTok{eigen_centrality}\NormalTok{(g.ergm.fbg.sim.convert)$vector)}
  \NormalTok{\}}
  
  \NormalTok{g.ergm2b.fbg.sim.df <-}\StringTok{ }\KeywordTok{as.data.frame}\NormalTok{(}\KeywordTok{cbind}\NormalTok{(g.ergm2b.fbg.sim.ecount, g.ergm2b.fbg.sim.coef, }
                                             \NormalTok{g.ergm2b.fbg.sim.apl, g.ergm2b.fbg.sim.dia, }
                                             \NormalTok{g.ergm2b.fbg.sim.avgdeg, g.ergm2b.fbg.sim.avgbtwcen, }
                                             \NormalTok{g.ergm2b.fbg.sim.avgclocen, g.ergm2b.fbg.sim.avgeigveccen))}
  ...
  \NormalTok{for (i in }\DecValTok{1}\NormalTok{:numsim) \{}
    ...
    \CommentTok{#observe the network statistics for this simulated graph}
    \NormalTok{g.ergm3a.fbg.sim.ecount[i] <-}\StringTok{ }\KeywordTok{ecount}\NormalTok{(g.ergm.fbg.sim.convert)}
    \NormalTok{g.ergm3a.fbg.sim.coef[i] <-}\StringTok{ }\KeywordTok{transitivity}\NormalTok{(g.ergm.fbg.sim.convert, }\DataTypeTok{type=}\StringTok{"localaverage"}\NormalTok{)}
    \NormalTok{g.ergm3a.fbg.sim.apl[i] <-}\StringTok{ }\KeywordTok{average.path.length}\NormalTok{(g.ergm.fbg.sim.convert)}
    \NormalTok{g.ergm3a.fbg.sim.dia[i] <-}\StringTok{ }\KeywordTok{diameter}\NormalTok{(g.ergm.fbg.sim.convert)}
    \NormalTok{g.ergm3a.fbg.sim.avgdeg[i] <-}\StringTok{ }\KeywordTok{mean}\NormalTok{(igraph::}\KeywordTok{degree}\NormalTok{(g.ergm.fbg.sim.convert))}
    \NormalTok{g.ergm3a.fbg.sim.avgbtwcen[i] <-}\StringTok{ }\KeywordTok{mean}\NormalTok{(igraph::}\KeywordTok{betweenness}\NormalTok{(g.ergm.fbg.sim.convert))}
    \NormalTok{g.ergm3a.fbg.sim.avgclocen[i] <-}\StringTok{ }\KeywordTok{mean}\NormalTok{(igraph::}\KeywordTok{closeness}\NormalTok{(g.ergm.fbg.sim.convert))}
    \NormalTok{g.ergm3a.fbg.sim.avgeigveccen[i] <-}\StringTok{ }\KeywordTok{mean}\NormalTok{(igraph::}\KeywordTok{eigen_centrality}\NormalTok{(g.ergm.fbg.sim.convert)$vector)}
  \NormalTok{\}}
  
  \NormalTok{g.ergm3a.fbg.sim.df <-}\StringTok{ }\KeywordTok{as.data.frame}\NormalTok{(}\KeywordTok{cbind}\NormalTok{(g.ergm3a.fbg.sim.ecount, g.ergm3a.fbg.sim.coef, }
                                             \NormalTok{g.ergm3a.fbg.sim.apl, g.ergm3a.fbg.sim.dia, }
                                             \NormalTok{g.ergm3a.fbg.sim.avgdeg, g.ergm3a.fbg.sim.avgbtwcen, }
                                             \NormalTok{g.ergm3a.fbg.sim.avgclocen, g.ergm3a.fbg.sim.avgeigveccen))}
  \end{Highlighting}
  \end{Shaded}
