...
A vertex $j$ is *reachable* from another vertex $i$ is there is a walk from $i$ to $j$. G is *connected* if all vertices in $G$ are is reachable by some other vertex in $G$. A *component* is a subgraph that is maximally connected. 
